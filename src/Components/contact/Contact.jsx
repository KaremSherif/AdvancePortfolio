...
const Contact = () => {
  return (
    <section className="contact section" id="contact">
      ...
      <span className="section-subtitle">Get Me In Touch</span>
      ...
      <div className="contact-container container grid">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">
                karemsherif2o2@gmail.com
              </span>
              <a
                href="mailto:karemsherif2o2@gmail.com"
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+201067608397</span>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://api.whatsapp.com/send?phone=01067608397&text=Hello, More Information!"
                className="contact-button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">Karemsherif2002bd</span>
              <a
        ...
        <div className="conatct-content">
          <h3 className="contact-title">Send Details</h3>
          <form action="" className="contact-form">
            <div className="contact-form-conta">
            ...
            <div className="contact-form-conta contact-form-area">
